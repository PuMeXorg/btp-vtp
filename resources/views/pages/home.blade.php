...
@section('description', 'Инженерный комфорт — проектирование, производство и поставка БТП, ИТП, ЦТП, насосных станций и систем автоматизации.')
    ...
    <div class="absolute inset-0">
        @if($hero?->image)
            <img
                ...
                alt="{{ $hero->title ?? 'Инженерный комфорт' }}"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
                ...
                <p class="text-gray-500 text-lg leading-relaxed mb-8">
                    Инженерный комфорт помогает заказчикам подобрать и реализовать инженерное решение под конкретный объект — без лишних согласований и непонятных технических формулировок.
                </p>
...
@php
    $reviewImages = [
        ...
        [
            'title' => 'Благодарственное письмо ГУП «ФХУ Комплекса Архитектуры, Строительства, Развития и Реконструкции Города»',
