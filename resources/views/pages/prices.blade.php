                ...
                <div class="bg-white rounded-3xl border border-gray-200 shadow-sm p-6 md:p-8">
                    <div class="mb-8">
                        ...
                        <p class="text-gray-600 leading-relaxed">
                            Это ориентировочная стоимость «от». Для точного коммерческого предложения отправьте заявку —
            ...
            <aside class="space-y-5">
                <div class="bg-gray-950 text-white rounded-3xl p-6">
                    ...
                    <p class="text-gray-300 leading-relaxed">
                        На сайте указаны ориентировочные цены «от». Итоговая стоимость зависит от комплектации,
                        мощности, автоматики, проектных требований и условий поставки.
                    </p>
                </div>

                <div class="bg-white rounded-3xl border border-gray-200 p-6 shadow-sm">
                    <h3 class="text-xl font-bold mb-4">В расчёте нет монтажа</h3>
                    <p class="text-gray-600 leading-relaxed">
                        Монтажные работы не включены в калькулятор, так как компания не занимается монтажом.
