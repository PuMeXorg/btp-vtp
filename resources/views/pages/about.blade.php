...
@section('title', 'О компании — Инженерный комфорт')
@section('description', 'ООО «Инженерный комфорт» — проектирование, монтаж и сдача тепловых пунктов в Москве и Московской области. Более 10 лет опыта, гарантия 60 месяцев.')
...
<section class="relative bg-gray-900 text-white overflow-hidden">
    ...
    <div class="relative container mx-auto max-w-7xl px-4 py-20">
        ...
        <p class="text-xl text-gray-300 max-w-2xl leading-relaxed">
            ООО «Инженерный комфорт» - надежный партнер в сфере поставки насосных станций, БТП и электрощитового оборудования собственного производства по России
        </p>
    </div>
</section>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
                <h2 class="text-3xl font-bold text-gray-900 mb-6">
                    Более 10 лет на рынке инженерных систем
                </h2>

                <p class="text-gray-600 leading-relaxed mb-4">
                    ООО «Инженерный комфорт» — надёжный российский производитель насосных станций,
            ...
            <div class="relative">
                <img src="{{ asset('/public/images/about/sotrudniki.jpg') }}"
                     alt="Команда Инженерный комфорт"
...
<section class="py-16 bg-white">
    <div class="container mx-auto max-w-7xl px-4">
        ...
        <div class="text-center mb-12">
            <h2 class="text-3xl font-bold text-gray-900 mb-3">Почему выбирают Инженерный комфорт</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="flex gap-4 p-6 rounded-2xl border border-gray-100 hover:border-primary/30 hover:shadow-md transition">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 leading-relaxed">Производственные мощности в г. Подольск и г. Москва, ул. Дорожная, д. 60Ас1. Блочные тепловые пункты, насосные станции повышения давления, пожаротушения, АУПД, электрощитовое оборудование.</p>
                </div>
            </div>
